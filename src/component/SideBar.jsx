    ...
    <div className="z-50 fixed top-1/2 right-0 -translate-y-1/2 flex items-center">
      <div className="z-50 bg-[#2f3335] sm:pr-4 pr-3 sm:pl-3 pl-2 sm:py-5 py-4 flex gap-4 flex-col rounded-tl-xl rounded-bl-xl">
        <a
          ...
          alt=""
          target="blank"
          className="w-5 h-5 sm:w-8 sm:h-8 rounded-md bg-red-500 p-1"
        >
        ...
        <a
          ...
          alt=""
          target="blank"
          className="w-5 h-5 sm:w-8 sm:h-8 rounded-md p-1 bg-blue-500"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
        ...
        <a
          ...
          alt=""
          target="blank"
          className="w-5 h-5 sm:w-8 sm:h-8 rounded-md p-1 bg-zinc-900"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
